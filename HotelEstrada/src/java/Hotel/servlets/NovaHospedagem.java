...
public class NovaHospedagem extends HttpServlet implements Tarefa {
    ...
    public String getHospedagens(HttpServletRequest req, HttpServletResponse resp){
        
        List<Hospedagem> hospedagem = null;
        

        try {
            hospedagem = new GenericDAO<Hospedagem>(Hospedagem.class
            ).getTodos();
        ...
        req.setAttribute("hospedagem", hospedagem);
        return "/WEB-INF/paginas/listaHospedagens.jsp";}
}
