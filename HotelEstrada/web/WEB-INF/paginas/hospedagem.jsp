...
<br/><br/>
        <form action="Controller">
            ...
            <br/><br/>
            <label for="input1" class="hora2">Data de Entrada</label> <input name="dataEntrada" type="date" >
            <br/><br/>
            <span><b>Clique aqui para fazer o check out:</b> </span>
            <br/><br/>
            <label for="input2" class="hora2">Data de Saída: </label><input type="date" name="dataSaida">
            <br/><br/>
