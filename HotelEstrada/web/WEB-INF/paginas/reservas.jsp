                ...
                <tbody>
                    <c:forEach var="reserva" items="${reservas}">
                        ...
                        <form action="Controller">
                            ...
                            <td><a href="Controller?tarefa=NovaHospedagem&id=<c:out value="${reserva.idReserva}"/>">Check-In</a></td>
                            <td><a href="Controller?tarefa=Checkout&id=<c:out value="${reserva.idReserva}"/>">Checkout</a></td>
